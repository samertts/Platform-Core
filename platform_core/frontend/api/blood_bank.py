...
@dataclass
class DonationClient(BaseEntityClient[Any]):
    ...
    def get_by_donor(self, donor_id: str) -> dict[str, Any]:
...
@dataclass
class BloodUnitClient(BaseEntityClient[Any]):
    ...
    def get_by_blood_type(self, blood_type: str) -> dict[str, Any]:
    ...
    def get_expiring(self, facility_id: str, days: int = 7) -> dict[str, Any]:
        return self.client.get(
            f"{self.endpoint}/expiring",
            params={"facility_id": facility_id, "days": days},
        )

    def crossmatch(self, blood_unit_id: str, patient_id: str) -> dict[str, Any]:
...
@dataclass
class TransfusionClient(BaseEntityClient[Any]):
    ...
    def get_by_blood_unit(self, blood_unit_id: str) -> dict[str, Any]:
        return self.client.get(f"{self.endpoint}/blood-unit/{blood_unit_id}")

    def record_reaction(self, transfusion_id: str, reaction: str) -> dict[str, Any]:
