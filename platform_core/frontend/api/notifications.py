...
@dataclass
class NotificationClient(BaseEntityClient[Any]):
    ...
    def get_unread(self, recipient_id: str) -> dict[str, Any]:
    ...
    def mark_all_read(self, recipient_id: str) -> dict[str, Any]:
...
@dataclass
class MessageClient(BaseEntityClient[Any]):
    ...
    def send(self, message_data: dict[str, Any]) -> dict[str, Any]:
    ...
    def get_conversation(self, user1_id: str, user2_id: str) -> dict[str, Any]:
