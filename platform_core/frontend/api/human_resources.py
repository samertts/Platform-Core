...
@dataclass
class ProfessionalClient(BaseEntityClient[Any]):
    ...
    def get_by_specialty(self, specialty: str) -> dict[str, Any]:
        return self.client.get(f"{self.endpoint}/specialty/{specialty}")


@dataclass
class LicenseClient(BaseEntityClient[Any]):
...
class OrganizationClient(BaseEntityClient[Any]):
    ...
    def get_by_type(self, organization_type: str) -> dict[str, Any]:
        return self.client.get(f"{self.endpoint}/type/{organization_type}")

    def get_facilities(self, organization_id: str) -> dict[str, Any]:
        return self.client.get(f"{self.endpoint}/{organization_id}/facilities")


@dataclass
class FacilityClient(BaseEntityClient[Any]):
    ...
    def get_by_organization(self, organization_id: str) -> dict[str, Any]:
        return self.client.get(f"{self.endpoint}/organization/{organization_id}")

    def get_by_type(self, facility_type: str) -> dict[str, Any]:
        return self.client.get(f"{self.endpoint}/type/{facility_type}")

    def get_departments(self, facility_id: str) -> dict[str, Any]:
        return self.client.get(f"{self.endpoint}/{facility_id}/departments")

    def get_beds(self, facility_id: str) -> dict[str, Any]:
        return self.client.get(f"{self.endpoint}/{facility_id}/beds")

    def get_capacity(self, facility_id: str) -> dict[str, Any]:
        return self.client.get(f"{self.endpoint}/{facility_id}/capacity")


@dataclass
class DepartmentClient(BaseEntityClient[Any]):
    ...
    def get_rooms(self, department_id: str) -> dict[str, Any]:
        return self.client.get(f"{self.endpoint}/{department_id}/rooms")


@dataclass
class RoomClient(BaseEntityClient[Any]):
...
@dataclass
class AttendanceClient(BaseEntityClient[Any]):
    ...
    def get_by_employee(self, employee_id: str) -> dict[str, Any]:
...
@dataclass
class LeaveClient(BaseEntityClient[Any]):
    ...
    def approve(self, leave_id: str, approver_id: str) -> dict[str, Any]:
        return self.client.put(
            f"{self.endpoint}/{leave_id}/approve", data={"approver_id": approver_id}
        )

    def reject(self, leave_id: str, reason: str) -> dict[str, Any]:
