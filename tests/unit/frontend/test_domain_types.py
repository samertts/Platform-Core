...
class TestCitizenTypes:
    def test_citizen_creation(self) -> None:
    ...
    def test_digital_credential_creation(self) -> None:
...
class TestHealthcareCoreTypes:
    ...
    def test_visit_creation(self) -> None:
    ...
    def test_admission_creation(self) -> None:
    ...
    def test_discharge_creation(self) -> None:
...
class TestLaboratoryTypes:
    def test_specimen_creation(self) -> None:
    ...
    def test_lab_order_creation(self) -> None:
...
class TestMedicalDeviceTypes:
    def test_medical_device_creation(self) -> None:
    ...
    def test_device_connection_creation(self) -> None:
...
class TestPharmacyTypes:
    ...
    def test_medication_creation(self) -> None:
    ...
    def test_dispensing_creation(self) -> None:
...
class TestClinicalTypes:
    def test_diagnosis_creation(self) -> None:
    ...
    def test_vital_signs_creation(self) -> None:
