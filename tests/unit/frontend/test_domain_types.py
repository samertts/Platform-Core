...
from platform_core.frontend.types.pharmacy import (
    Prescription, Medication, Dispensing
)
from platform_core.frontend.types.clinical import (
...
class TestClinicalTypes:
    ...
    def test_procedure_creation(self):
        procedure = Procedure(patient_id="p1", procedure_code="99213", procedure_name="Office visit")
